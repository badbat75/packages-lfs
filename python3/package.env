...
PKG_MAKEVARS="LIBDEST=${INSTALL_EXECPREFIX}/lib/python$(echo "${PKG_VER}" | cut -d. -f1,2)/site-packages"
PKG_OVERRIDELTO=0
PKG_FAULTYCFLAGS=1
...
PYTHON_MODPATH=\${PKG_PKGPATH}${INSTALL_EXECPREFIX}/lib/python$(echo "${PKG_VER}" | cut -d. -f1,2)/site-packages
